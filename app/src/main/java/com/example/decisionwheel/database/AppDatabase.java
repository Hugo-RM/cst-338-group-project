...
@Database(entities = {UserEntity.class, WheelEntity.class, Slice.class}, version = 1, exportSchema = false)
    ...
    private static final RoomDatabase.Callback seedCallback = new RoomDatabase.Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            databaseWriteExecutor.execute(() -> {
                ...
                UserEntity testUser = new UserEntity("testuser1", "testuser1");
                dao.insert(testUser);

                UserEntity admin = new UserEntity("admin2", "admin2");
                admin.setAdmin(true);
                dao.insert(admin);
            });
        }
